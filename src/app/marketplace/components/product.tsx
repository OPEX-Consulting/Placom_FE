...
export function Product({product}: {product: any }) {
  return (
    <Card className="bg-white min-w-[280px] md:min-w-[280px] shadow-none border-none group py-0 mb-10">
        <CardContent className="p-0">
            <div className="relative">
                <Image
                    ...
                    onClick={()=>location.href = `/marketplace/${product?.id}`}
                />
            ...
            <div className="px-4 py-2">
                <div className="flex items-center justify-between">
                    <div>
                        <h3 className="font-semibold text-lg cursor-pointer" onClick={()=>location.href = `/marketplace/${product?.id}`}>{product?.name}</h3>
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="relative hover:bg-[#F6FFE9] rounded-full transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" width={25} height={25} viewBox="0 0 24 24">
                            <path fill={product?.id in cartItems? "#8AC73C":"#27AE60"} d="M16 18a2 2 0 0 1 2 2a2 2 0 0 1-2 2a2 2 0 0 1-2-2a2 2 0 0 1 2-2m0 1a1 1 0 0 0-1 1a1 1 0 0 0 1 1a1 1 0 0 0 1-1a1 1 0 0 0-1-1m-9-1a2 2 0 0 1 2 2a2 2 0 0 1-2 2a2 2 0 0 1-2-2a2 2 0 0 1 2-2m0 1a1 1 0 0 0-1 1a1 1 0 0 0 1 1a1 1 0 0 0 1-1a1 1 0 0 0-1-1M18 6H4.27l2.55 6H15c.33 0 .62-.16.8-.4l3-4c.13-.17.2-.38.2-.6a1 1 0 0 0-1-1m-3 7H6.87l-.77 1.56L6 15a1 1 0 0 0 1 1h11v1H7a2 2 0 0 1-2-2a2 2 0 0 1 .25-.97l.72-1.47L2.34 4H1V3h2l.85 2H18a2 2 0 0 1 2 2c0 .5-.17.92-.45 1.26l-2.91 3.89c-.36.51-.96.85-1.64.85"></path>
                        </svg>
                        {product?.id in cartItems && <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 15 15" className="absolute top-0 right-0 bg-white rounded-full">
                            <path fill="none" stroke="#8AC73C" d="M4 7.5L7 10l4-5" strokeWidth={1}></path>
                        </svg>}
                    </div>
                </div>
            </div>
